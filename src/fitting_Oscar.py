...
def Cohen_movObst_exp1():
    # print('Loading input')  
    # Create job list
    model_names = ['mass_spring_approach', 'cohen_avoid']
    arg_names = [('t_relax', 'b', 'k_g', 'c1', 'c2'),
                 ('b1', 'k1', 'c5', 'c6', 'b2', 'k2', 'c7', 'c8')]
    arg_vals = list(product([0.7],
                            [3.25],
                            [7.5],
                            [0.4],
                            [0.4],
...
def Fajen_steer_exp1a():
    # Create job list
    model_names = ['mass_spring_approach']
    arg_names = [('b', 'k_g', 'c1', 'c2', 't_relax')]
    arg_vals = list(product([3.25],
                            [7.5],
                            [0.4],
                            [0.4],
                            np.linspace(0.5, 3, 260)))
